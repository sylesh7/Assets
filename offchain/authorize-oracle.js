...
async function authorizeOracle() {
  try {
    ...
    console.log('🔍 Checking if oracle is already authorized...');
    ...
    console.log('📝 Oracle not authorized yet. Authorizing...\n');
    ...
    if (receipt.status === 'success') {
      ...
      console.log(`   Oracle Address: ${ORACLE_ADDRESS}\n`);
      console.log('🎉 You can now start the oracle backend with: npm run dev');
    } else {
