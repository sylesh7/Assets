...
async function main() {
    try {
        ...
        logger_1.logger.info('🤖 RWA ORACLE STARTING ON ETHEREUM SEPOLIA');
        logger_1.logger.info('═══════════════════════════════════════════════════════════════');
        logger_1.logger.info(`Oracle Core Address: ${process.env.RWA_ORACLE_CORE_ADDRESS}`);
        logger_1.logger.info(`Asset Manager Address: ${process.env.RWA_ASSET_MANAGER_ADDRESS}`);
        logger_1.logger.info('═══════════════════════════════════════════════════════════════\n');
