...
export const propertyValuationAgent = new Agent({
  id: 'property-valuation-agent',
  name: 'Property Valuation Agent',
  instructions: `You are an expert real estate appraiser. Analyze property data and provide accurate valuations.
